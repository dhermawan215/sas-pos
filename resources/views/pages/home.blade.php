              ...
              <ul class="dropdown-menu" aria-labelledby="navbarDropdown" style="width: 500%">
                <table class="table table-borderless">
                  ...
                  <tbody>
                    <tr>
                      <td>
                        <p style="font-size: 16px">Cocok untuk restoran, kedai kopi, minuman, cepat saji, toko roti, dan katering.</p>
                      </td>
                      <td>
                        <p style="font-size: 16px">Cocok untuk restoran, kedai kopi,toko roti, dan katering. </p>
                      </td>
                      <td>
                        <p style="font-size: 16px">Cocok untuk restoran, kedai kopi, dan katering.</p>
                      </td>
                    </tr>
                  </tbody>
                </table>
